    ...
    <div class="container p-8 mx-auto xl:px-0 flex flex-wrap ">
        <div class="flex items-center w-full lg:w-1/2">
            <div class="max-w-2xl mb-8">
                ...
                <p class="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">Nextly is
                    Kini hadir EduTech Masa Kini dengan banyak teknologi untuk belajar!</p>
                <div class="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                    <a href="https://web3templates.com/templates/nextly-landing-page-template-for-startups"
                        target="_blank" rel="noopener"
                        class="px-8 py-4 text-lg font-medium text-center text-white bg-indigo-600 rounded-md ">Mulai
                    </a>
                </div>
            </div>
        </div>
        <div class="flex items-center justify-center w-full lg:w-1/2">
            <x-icons.undraw_reading />
        </div>
    </div>
    ...
    <div class="container p-8 mx-auto xl:px-0 ">
        <div class="flex flex-col justify-center">
            <div class="text-xl text-center text-gray-700 dark:text-white">Trusted by <span
                    class="text-indigo-600">2000+</span> <!-- -->customers worldwide</div>
            <div class="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
                <div class="pt-2 text-gray-400 dark:text-gray-400"><svg xmlns="http://www.w3.org/2000/svg"
                        width="110" height="33" fill="none" viewBox="0 0 110 33">
                ...
                <div class="pt-1 text-gray-400 dark:text-gray-400"><svg xmlns="http://www.w3.org/2000/svg"
                        width="108" height="29" fill="none" viewBox="0 0 108 29">
                        <g>
                            <path fill="currentColor"
                ...
                <div class="pt-2 text-gray-400 dark:text-gray-400"><svg xmlns="http://www.w3.org/2000/svg"
                        width="136" height="24" viewBox="0 0 351 61">
                        <g fill="none" fill-rule="evenodd" stroke="none" stroke-width="1">
    ...
    <div id="features">
        <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            <div class="md:w-2/3 lg:w-1/2">
                ...
                <p class="text-gray-600 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit.
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            <div class="relative">
                <div class="flex items-center justify-center -space-x-2">
                    ...
                    <img loading="lazy" width="200" height="200" src="https://picsum.photos/id/220/200/300"
                        alt="member photo" class="h-12 w-12 rounded-full object-cover">
                    <img loading="lazy" width="200" height="200" src="https://picsum.photos/id/320/200/300"
                        alt="member photo" class="z-10 h-16 w-16 rounded-full object-cover">
                    <img loading="lazy" width="200" height="200" src="https://picsum.photos/id/420/200/300"
                        alt="member photo" class="relative h-12 w-12 rounded-full object-cover">
                    <img loading="lazy" width="200" height="200" src="https://picsum.photos/id/520/200/300"
                        alt="member photo" class="h-8 w-8 rounded-full object-cover">
                </div>
