<x-guest-layout>
    ...
    <div class="w-screen relative bg-cover bg-center bg-no-repeat py-8"
        style="background-image: url(https://picsum.photos/id/280/2000/800)">
        <div
        ...
        <div class="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
            <div class="flex flex-col items-center justify-center lg:flex-row">
                <div class="rounded-full border-8 border-primary shadow-xl">
                    <img src="https://picsum.photos/id/950/200/200" class="h-48 rounded-full sm:h-56" alt="author">
                </div>
                <div class="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                    <h1 class="text-center font-header text-4xl text-white sm:text-left sm:text-5xl md:text-6xl">
                        Hello We Are EduTech!
                    </h1>
                </div>
            </div>
        </div>
    ...
    <!--Hero 2-->
    <div class="container">
        <div class="mx-auto w-5/6 dark:fill-white dark:text-white py-16 shadow md:w-11/12 lg:py-20 xl:py-24 2xl:w-full">
    ...
    <!--Hero 3-->
    <div class="container py-16 md:py-20 dark:text-white" id="portfolio">
        <h2 class="text-center font-header text-4xl font-semibold uppercase text-primary sm:text-5xl lg:text-6xl">
            Check out my Portfolio
        </h2>
        <h3 class="pt-6 text-center font-header text-xl font-medium sm:text-2xl lg:text-3xl">
        ...
        <div class="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
            <a href="/" class="mx-auto transform transition-all hover:scale-105 md:mx-0">
                <img src="https://picsum.photos/id/140/800/400" class="w-full shadow" alt="portfolio image">
            </a>
            <a href="/" class="mx-auto transform transition-all hover:scale-105 md:mx-0">
                <img src="https://picsum.photos/id/160/800/400" class="w-full shadow" alt="portfolio image">
            </a>
            <a href="/" class="mx-auto transform transition-all hover:scale-105 md:mx-0">
                <img src="https://picsum.photos/id/180/800/400" class="w-full shadow" alt="portfolio image">
            </a>
            <a href="/" class="mx-auto transform transition-all hover:scale-105 md:mx-0">
                <img src="https://picsum.photos/id/200/800/400" class="w-full shadow" alt="portfolio image">
            </a>
        </div>
    </div>
