<x-guest-layout>
    <div x-data="{ open: false }" class="container py-16 md:py-20 dark:text-white" id="contact">
        ...
        <div class="flex flex-col pt-16 lg:flex-row dark:text-white">
